...
app.get('/healthz', (_req, res) =>
  res.json({ ok: true, service: 'us-build-a-colony', liveSessions: manager.registry.sessions.size }));
...
server.listen(config.port, () => {
  console.log(`[us-build-a-colony] listening on :${config.port} — sessions live in memory only`);
});
